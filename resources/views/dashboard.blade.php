    ...
    <style>
        ...
        .dashboard-wrap {
            ...
            /* 
            * DIUBAH: ditambah padding-top agar teks turun
            * dan tidak menabrak renda
            */
            padding-top: 20px;
        }
        ...
        @media (max-width: 700px) {
            ...
            /* Header right di mobile: rapi horizontal */
            .dash-header-right {
                width: 100%;
                flex-wrap: wrap;
                gap: 10px;
            ...
            .dash-user-info span {
                display: none; /* sembunyikan "Pemilik Toko" di mobile */
            }

            /* Hero lebih kecil di mobile */
            .dash-hero {
                height: 80px;
            }
    ...
    <div class="dashboard-wrap">
        ...
        ====================================================== -->
        <div class="dash-hero">
            {{-- Ganti src dengan gambar ilustrasi bakery Anda --}}
