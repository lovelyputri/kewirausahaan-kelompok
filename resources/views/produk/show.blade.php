...
<style>
    ...
    .produk-detail-page .breadcrumb { display: flex; align-items: center; gap: 6px; font-family: "Inter", sans-serif; font-size: 12px; color: #a89a8c; margin-bottom: 14px; max-width: 720px; margin-left: auto; margin-right: auto; }
    .produk-detail-page .breadcrumb a { color: #a89a8c; text-decoration: none; display: flex; align-items: center; transition: color .2s; }
    ...
    .produk-detail-page .page-icon { width: 48px; height: 48px; background: #6b4d38; color: #fff; border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; box-shadow: 0 2px 8px rgba(107,77,56,.28); }
    .produk-detail-page .page-icon i { width: 24px; height: 24px; stroke-width: 2; }
    .produk-detail-page .page-title { font-family: "DM Serif Display", serif; font-size: 26px; font-weight: 400; color: #3f3025; margin: 0 0 2px 0; letter-spacing: .3px; line-height: 1.1; }
    .produk-detail-page .page-subtitle { font-family: "Inter", sans-serif; font-size: 12px; color: #a89a8c; margin: 0; }
    .produk-detail-page .btn-back { display: inline-flex; align-items: center; gap: 6px; background: #f5efe8; color: #6b4d38; padding: 10px 18px; border-radius: 10px; font-family: "Inter", sans-serif; font-size: 13px; font-weight: 500; text-decoration: none; transition: background .2s; border: none; cursor: pointer; white-space: nowrap; }
    .produk-detail-page .btn-back:hover { background: #e8ded3; }
    .produk-detail-page .btn-back i { width: 15px; height: 15px; stroke-width: 2.2; }

    .produk-detail-page .detail-card { background: #fff; border: 1px solid #f0e8de; border-radius: 16px; padding: 28px; box-shadow: 0 1px 4px rgba(107,77,56,.04); max-width: 720px; margin: 0 auto; }
    ...
    .produk-detail-page .detail-hero-img { width: 100px; height: 100px; border-radius: 16px; overflow: hidden; border: 1px solid #f0e8de; background: #faf7f3; flex-shrink: 0; }
    ...
    .produk-detail-page .detail-hero-name { font-family: "DM Serif Display", serif; font-size: 24px; font-weight: 400; color: #3f3025; margin: 0 0 6px 0; line-height: 1.2; letter-spacing: .3px; }
    .produk-detail-page .detail-hero-kode { font-family: "Courier New", monospace; font-size: 12px; font-weight: 600; color: #a89a8c; letter-spacing: .5px; margin-bottom: 10px; }
    .produk-detail-page .detail-hero-badges { display: flex; align-items: center; gap: 6px; flex-wrap: wrap; }

    .produk-detail-page .badge-kategori { display: inline-block; padding: 5px 14px; border-radius: 999px; font-family: "Inter", sans-serif; font-size: 11.5px; font-weight: 600; line-height: 1.4; white-space: nowrap; }
    ...
    .produk-detail-page .badge-status { display: inline-block; padding: 5px 14px; border-radius: 999px; font-family: "Inter", sans-serif; font-size: 11.5px; font-weight: 600; line-height: 1.4; white-space: nowrap; }
    ...
    .produk-detail-page .detail-section-title { display: flex; align-items: center; gap: 8px; font-family: "Inter", sans-serif; font-size: 12px; font-weight: 700; color: #6b4d38; text-transform: uppercase; letter-spacing: .8px; margin-bottom: 16px; padding-bottom: 10px; border-bottom: 1px solid #f0e8de; }
    .produk-detail-page .detail-section-title i { width: 15px; height: 15px; stroke-width: 2.2; color: #a89a8c; }
    ...
    .produk-detail-page .detail-item-label { font-family: "Inter", sans-serif; font-size: 11px; font-weight: 600; color: #a89a8c; text-transform: uppercase; letter-spacing: .5px; }
    .produk-detail-page .detail-item-value { font-family: "Inter", sans-serif; font-size: 15px; font-weight: 600; color: #3f3025; line-height: 1.3; }
    ...
    .produk-detail-page .btn-edit { display: inline-flex; align-items: center; justify-content: center; gap: 8px; background: #6b4d38; color: #fff; padding: 12px 26px; border-radius: 10px; font-family: "Inter", sans-serif; font-size: 13.5px; font-weight: 600; text-decoration: none; transition: background .2s; box-shadow: 0 2px 8px rgba(107,77,56,.22); border: none; cursor: pointer; white-space: nowrap; min-width: 140px; }
    .produk-detail-page .btn-edit:hover { background: #4a3526; }
    .produk-detail-page .btn-edit i { width: 16px; height: 16px; stroke-width: 2.5; }

    .produk-detail-page .btn-delete { display: inline-flex; align-items: center; justify-content: center; gap: 8px; background: #fff1f2; color: #e11d48; border: 1px solid #fecdd3; padding: 12px 26px; border-radius: 10px; font-family: "Inter", sans-serif; font-size: 13.5px; font-weight: 600; text-decoration: none; transition: all .2s; cursor: pointer; white-space: nowrap; min-width: 140px; }
    ...
    @media (max-width: 700px) {
        ...
        .produk-detail-page .detail-hero { flex-direction: column; align-items: center; text-align: center; gap: 16px; }
        .produk-detail-page .detail-hero-img { width: 120px; height: 120px; }
        .produk-detail-page .detail-hero-name { font-size: 20px; }
        .produk-detail-page .detail-hero-badges { justify-content: center; }
    ...
    <div class="detail-card">
        ...
        <div class="detail-hero">
            <div class="detail-hero-img">
                ...
                @else
                    <img src="{{ asset('images/default.png') }}" alt="Produk">
                @endif
            </div>
