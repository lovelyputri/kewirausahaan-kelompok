...
<style>
    ...
    .produk-pagination-links nav > div:first-child {
        display: none;
    }

    .produk-pagination-links nav > div:last-child {
        display: flex;
        align-items: center;
        gap: 4px;
    }
    ...
    .produk-pagination-links span[aria-current="page"] {
        background: #6b4d38;
        border-color: #6b4d38;
        color: #fff;
    }

    .produk-pagination-links a[rel="prev"],
    .produk-pagination-links a[rel="next"] {
        padding: 0 10px;
    }
    ...
    .detail-product-placeholder svg {
