...
<style>
    ...
    .produk-form-page .breadcrumb a { color: #a89a8c; text-decoration: none; }
    .produk-form-page .breadcrumb a:hover { color: #6b4d38; }
    .produk-form-page .breadcrumb .sep { color: #d6c9bb; }
    ...
    .produk-form-page .page-icon { width: 48px; height: 48px; background: #6b4d38; color: #fff; border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .produk-form-page .page-icon i { width: 24px; height: 24px; }
    ...
    .produk-form-page .form-section-title i { width: 15px; height: 15px; }
    ...
    .produk-form-page .form-input, .produk-form-page .form-select { width: 100%; height: 46px; padding: 0 16px; background: #faf7f3; border: 1px solid #f0e8de; border-radius: 10px; font-size: 13.5px; color: #3f3025; outline: none; transition: .2s; }
    ...
    .produk-form-page .info-card { background: #faf7f3; border: 1px solid #f0e8de; border-radius: 12px; padding: 12px 16px; margin-bottom: 20px; display: flex; align-items: center; gap: 10px; font-size: 12.5px; color: #6b4d38; }
    ...
    /* Upload gambar */
    .produk-form-page .file-input-wrap { position: relative; }
    .produk-form-page .file-input-wrap input[type="file"] { position: absolute; left: 0; top: 0; width: 100%; height: 100%; opacity: 0; cursor: pointer; }
    .produk-form-page .file-input-display { display: flex; align-items: center; gap: 10px; height: 46px; padding: 0 16px; background: #faf7f3; border: 1px dashed #c9b5a4; border-radius: 10px; color: #6b4d38; font-size: 13px; transition: .2s; }
    .produk-form-page .file-input-wrap:hover .file-input-display { background: #f5efe8; border-color: #6b4d38; }
    .produk-form-page .file-input-display i { width: 18px; height: 18px; color: #a89a8c; }
    .produk-form-page .gambar-preview { margin-top: 12px; width: 130px; height: 130px; border-radius: 12px; border: 1px solid #e8ddd2; background: #faf7f3; overflow: hidden; display: flex; align-items: center; justify-content: center; color: #b8aa9c; font-size: 11px; }
    .produk-form-page .gambar-preview img { width: 100%; height: 100%; object-fit: cover; display: block; }

    .produk-form-page .hapus-gambar-wrap { margin-top: 8px; display: flex; align-items: center; gap: 6px; }
    .produk-form-page .hapus-gambar-wrap input { width: 16px; height: 16px; }
    .produk-form-page .hapus-gambar-wrap label { font-size: 12px; color: #be123c; cursor: pointer; }
...
<div class="produk-form-page">
    ...
    <div class="page-header">
        <div class="page-header-left">
            <div class="page-icon"><i data-lucide="package-open"></i></div>
            <div>
    ...
    <div class="form-card">
        ...
        <div class="info-card">
            ...
            <div>
                Mengedit: <strong>{{ $produk->nama_produk }}</strong>
                <span style="color:#a89a8c;">({{ $produk->kode_produk ?? sprintf('%08d', $produk->id) }})</span>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('produk.update', $produk->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="id_kategori" class="form-select" required>
                    @foreach($kategoris as $k)
                        <option value="{{ $k->id }}" {{ old('id_kategori', $produk->id_kategori) == $k->id ? 'selected' : '' }}>
                            {{ $k->nama_kategori }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @if($produk->gambar)
                    <div style="margin-bottom:12px;">
                        <img src="{{ asset('storage/' . $produk->gambar) }}"
                             ...
                             style="width:130px; height:130px; object-fit:cover; border-radius:12px; border:1px solid #e8ddd2;">
                        <div class="hapus-gambar-wrap">
                ...
                <div class="gambar-preview" id="gambarPreview" style="{{ $produk->gambar ? 'display:none;' : '' }}">
                    <span>Preview</span>
                </div>
