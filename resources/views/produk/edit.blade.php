...
<style>
    /* =====================================================
       SCOPE KHUSUS HALAMAN EDIT PRODUK
    ===================================================== */
    ...
    /* ---------- CUSTOM DROPDOWN ---------- */
    .produk-form-page .dropdown {
        position: relative;
    }
    .produk-form-page .dropdown-toggle {
        width: 100%;
        height: 46px;
    ...
    .produk-form-page .dropdown.open .dropdown-toggle {
        border-color: #6b4d38;
        background: #fff;
        box-shadow: 0 0 0 3px rgba(107,77,56,.08);
    }
    .produk-form-page .dropdown-toggle .icon-lead {
        position: absolute;
        left: 14px;
        top: 50%;
        transform: translateY(-50%);
    ...
    .produk-form-page .dropdown-toggle .icon-chevron {
        position: absolute;
        right: 14px;
        top: 50%;
        transform: translateY(-50%);
    ...
    .produk-form-page .dropdown.open .icon-chevron {
        transform: translateY(-50%) rotate(180deg);
    }
    .produk-form-page .dropdown-label {
        overflow: hidden;
        text-overflow: ellipsis;
        white-space: nowrap;
    }
    .produk-form-page .dropdown-label.placeholder {
        color: #b8aa9c;
    }
    .produk-form-page .dropdown-menu {
        position: absolute;
        top: calc(100% + 6px);
        left: 0;
        right: 0;
    ...
    .produk-form-page .dropdown.open .dropdown-menu {
        opacity: 1;
        visibility: visible;
        transform: translateY(0);
    }
    .produk-form-page .dropdown-item {
        display: flex;
        align-items: center;
        gap: 8px;
        padding: 10px 12px;
    ...
    .produk-form-page .dropdown-item:hover {
        background: #faf7f3;
        color: #6b4d38;
    }
    .produk-form-page .dropdown-item.selected {
        background: #f5efe8;
        color: #6b4d38;
        font-weight: 600;
    }
    .produk-form-page .dropdown-item .check {
        margin-left: auto;
        width: 14px;
        height: 14px;
        color: #6b4d38;
    ...
    .produk-form-page .info-card i {
        width: 16px; height: 16px;
        color: #a89a8c;
        flex-shrink: 0;
    }
    .produk-form-page .info-card strong {
        font-weight: 700;
        color: #3f3025;
    }
    ...
    <div class="page-header">
        <div class="page-header-left">
            ...
            <div>
                ...
                <p class="page-subtitle">Perbarui informasi produk yang sudah ada di toko Anda.</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('produk.update', $produk->id) }}">
            ...
            <div class="form-group">
                ...
                <div class="dropdown" data-dropdown>
                    <input type="hidden" name="id_kategori" value="{{ old('id_kategori', $produk->id_kategori) }}" required>
                    <button type="button" class="dropdown-toggle" onclick="toggleDropdown(this)">
                        <i data-lucide="layout-grid" class="icon-lead"></i>
                        <span class="dropdown-label {{ old('id_kategori', $produk->id_kategori) ? '' : 'placeholder' }}">
                            @php
                                $selectedKat = $kategoris->firstWhere('id', old('id_kategori', $produk->id_kategori));
                            @endphp
                    ...
                    <div class="dropdown-menu">
                        @foreach($kategoris as $k)
                            <button type="button"
                                    class="dropdown-item {{ old('id_kategori', $produk->id_kategori) == $k->id ? 'selected' : '' }}"
