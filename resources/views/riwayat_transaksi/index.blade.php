...
<style>
    ...
    .detail-produk-table th.right {
        text-align: right;
    }

    .detail-produk-table th.center {
        text-align: center;
    }

    .detail-produk-table td {
        padding: 6px 0;
        border-bottom: 1px dashed #f4eee8;
        color: #3f3025;
    }

    .detail-produk-table td.right {
        text-align: right;
    }

    .detail-produk-table td.center {
        text-align: center;
    }
...
<div class="rt-page">
    ...
    <div class="rt-header">
        ...
        <div class="rt-header-left">
            ...
            <div>
                ...
                <p class="rt-subtitle">
                    Daftar riwayat pembelian yang sudah selesai
                </p>
    ...
    <div class="rt-filter-card">
        ...
        <form
            method="GET"
            action="{{ route('riwayat_transaksi.index') }}"
            class="rt-filter-form"
        >

            {{-- SEARCH --}}
            <div class="rt-filter-group">

                <label class="rt-filter-label">
                    Cari Transaksi
                </label>
        ...
        <div class="rt-table-card">
            ...
            <div class="rt-table-header">
                ...
                <div>
                    ...
                    <h2 class="rt-table-title">
                        Daftar Transaksi
                    </h2>

                    <div class="rt-table-count">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const layout =
            document.getElementById('rtContentLayout');

        const panel =
            document.getElementById('rtDetailPanel');
        ...
        document.addEventListener(
            ...
            function (event) {
                ...
                .then(function (data) {
                    ...
                    /* CREATE ICON SETELAH HTML MASUK */
                    if (
                        typeof lucide !== 'undefined'
                    ) {
                        lucide.createIcons();
